...
namespace DAL.Migrations
{
    public partial class anything : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UserSessionTrackings",
                columns: table => new
                {
                    UserSessionTrackingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    AuthenticationToken = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSessionTrackings", x => x.UserSessionTrackingId);
                });
        }
